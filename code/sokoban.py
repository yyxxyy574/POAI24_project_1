...
ACTION = {(0, -1): 8593, (-1, 0): 8592, (0, 1): 8595, (1, 0): 8594}
...
def SelectMapMenu(game_mode):
    ...
    while not end:
        ...
        title = font_title.render('Sokoban', True, (0, 255, 125), (53, 73, 94))
        screen.blit(title, (120, 100))
        demo1 = font_choice.render('Demo1', True, (40, 255, 40), (53, 73, 94))
        screen.blit(demo1, (182, 200))
        demo2 = font_choice.render('Demo2', True, (40, 255, 40), (53, 73, 94))
        screen.blit(demo2, (182, 250))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                mouse = pygame.mouse.get_pos()
                # If the user click the "Demo1" button
                if 182 <= mouse[0] <= 250 and 200 <= mouse[1] <= 232:
                    GamePlayMenu(game_mode=game_mode, map_mode="demo1")
                    end = True
                # If the user click the "Demo2" button
                if 182 <= mouse[0] <= 250 and 250 <= mouse[1] <= 282:
                    GamePlayMenu(game_mode=game_mode, map_mode="demo2")
                    end = True
    ...
    while not end:
        ...
        for event in pygame.event.get():
            ...
            if current_game_map.is_success():
                for move in current_game_map.move_sequence:
                    print(chr(ACTION[move]), end=' ')
                print()
